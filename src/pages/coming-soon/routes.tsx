...
export const emBreveRoutes: RouteObject[] = [
  ...
  { path: paths.analise, element: <Navigate to={paths.visaoGeral} replace /> },
  // Equipe virou aba do Dashboard, com filtro compartilhado: ver src/pages/equipe/routes.tsx.
  // Metas saiu de Configurações: ver src/pages/metas/routes.tsx (redirect legado).
  ...
  { path: paths.configuracoes.colaboradores, element: <EmBreve titulo="Colaboradores" fase={FASE2} descricao="Quem vem do ERP e o que é só nosso: e-mail, celular, aniversário, grupo, tipo e inatividade." itens={["Lista por filial com status no ERP e no app", "Convidar e reenviar convite", "Marcar como inativo com motivo e data, aceitando retroativo", "Marcar como caixa central e configurar rateio"]} /> },
  { path: paths.configuracoes.grupos, element: <EmBreve titulo="Grupos e tarefas" fase={FASE3} descricao="Grupo tem nome e horário. Tarefa é da loja, por grupo, e reseta na virada." itens={["Grupos por filial cobrindo as pontas do dia", "Tarefas por grupo com ordem", "Painel de conclusão por grupo, nunca nominal"]} /> },
  { path: paths.configuracoes.turnosLegado, element: <Navigate to={paths.configuracoes.grupos} replace /> },
  ...
  { path: paths.vendedora.tarefas, element: <EmBreve titulo="Tarefas" fase={FASE3} descricao="Checklist do grupo atual. Qualquer colaboradora marca, o sistema registra quem." itens={["Grupo atual com horário e progresso", "Checkbox grande por tarefa, na ordem configurada", "Grupos anteriores do dia recolhidos, somente leitura", "Reseta na virada do grupo"]} /> },
