...
24. ✅ **Configurações > Lojas — fuso + horário** (2026-09-23) — tela simples em `/configuracoes/lojas`.
 ...
 - **Padrão = todos os dias desligados** (2026-09-26, migration `20260926190000_store_hours_default_off`; antes seg–sáb 09–21). Nenhum dia aberto = **horário não configurado**: a tela mostra tudo off, mas cálculos usam **10:00–22:00 todos os dias** (`effectiveWeekHours` nos eixos/curva da meta; `parseStoreHours` na atualização automática/fechamento) — loja nova continua sincronizando. Lojas existentes não mudaram. Configurar o horário entra no futuro tutorial **"Primeiros passos"** (passos guiados que o gestor executa e vai concluindo).
