...
16. ✅ **Botão Atualizar (FORCE)** (2026-09-21; **loja + cooldown 2026-09-22**) — período filtrado + hoje; teto 90 dias. Escopo = loja do StorePicker (`storeIds`); “Todas” = rede. Cooldown **5 min por loja**; “Todas” bloqueia se **qualquer** FORCE recente (opção A). FORCE “Todas” recente também bloqueia cada loja. FORCE bem-sucedido grava `last_light_sync_at` → reinicia LIGHT (5 min, rede). Worker: 1 job RUNNING/credencial (fila), escopo por loja no payload.
