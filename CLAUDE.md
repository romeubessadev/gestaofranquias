...
16. ✅ **Botão Atualizar (FORCE)** (2026-09-21; **loja 2026-09-22**) — **não** é só “hoje”. Refaz o **período filtrado** (preenche buracos dia a dia) e **sempre inclui hoje**; teto 90 dias; rate limit 1× / 5 min. Escopo = **loja do StorePicker** (`storeIds` no payload); “Todas as lojas” = rede inteira. Sync automático periódico = `LIGHT` (só hoje).
